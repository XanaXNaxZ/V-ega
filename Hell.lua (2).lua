...
local function HeartbeatUpdate()
    ...
    FpsLabel.Text = ("IDK:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
Start = tick()
Heartbeat:Connect(HeartbeatUpdate)
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "Hell"; Text ="您未被加入白名单"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "Hell"; Text ="Fake😆"; Duration = 4; })

local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/XanaXNaxZ/AchoAchoAchoAchoAchoAchoAchoAchoAchoAchoAcho/refs/heads/main/1ui.txt"))();        
local win = ui:new("ParadiseHub")
--
...
about:Label("Hell")
about:Label("邮箱¹")
about:Label("Achlololol@outlook.com")
about:Label("IDK")
about:Label("IDK")
about:Label("IDK")
about:Label("IDK")

local about = UITab1:section("缝的",false)
...
about:Button("获得GamePass(没用)",function()
...
local UITab74 = win:Tab("『尘土飞扬的旅行可能用不了』",'7734068321')

local about = UITab74:section("『尘土飞扬的旅行』",true)

about:Button("尘土飞扬的旅行",function()
loadstring(game:HttpGet("https://scriptblox.com/raw/a-dusty-trip-FREE-CAR-Gui-14352"))()
end)

local UITab75 = win:Tab("『亡灵防御大亨』",'7734068321')

local about = UITab75:section("『亡灵防御大亨』",true)

about:Button("亡灵防御大亨",function()
loadstring(game:HttpGet"https://thedragonslayer2.github.io/AutoExec.html")()
end)

local UITab76 = win:Tab("『越狱』",'7734068321')

local about = UITab76:section("『越狱』",true)
...
local UITab77 = win:Tab("『格林维尔』",'7734068321')

local about = UITab77:section("『格林维尔』",true)
...
local NotificationHolder = loadstring(game:HttpGet("https://raw.githubusercontent.com/BocusLuke/UI/main/STX/Module.Lua"))() 
 ...
 wait(1) 
 Notification:Notify( 
     {Title = "蓝标", Description = "正在加载"}, 
     {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "image"}, 
     {Image = "http://www.roblox.com/asset/?id=4483345998", ImageColor = Color3.fromRGB(255, 84, 84)} 
 ) 
 wait(2) 
 Notification:Notify( 
     {Title = "蓝标", Description = "准备好了！"}, 
     {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "image"}, 
     {Image = "http://www.roblox.com/asset/?id=4483345998", ImageColor = Color3.fromRGB(255, 84, 84)} 
 )
 wait(0.2)
 Notification:Notify( 
     {Title = "蓝标", Description = "夏团队"}, 
...
local UITab78 = win:Tab("『感染力的微笑』",'7734068321')

local about = UITab78:section("『感染力的微笑』",true)

about:Button("感染力的微笑",function()
local NotificationHolder = loadstring(game:HttpGet("https://raw.githubusercontent.com/BocusLuke/UI/main/STX/Module.Lua"))() 
 local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/BocusLuke/UI/main/STX/Client.Lua"))() 
